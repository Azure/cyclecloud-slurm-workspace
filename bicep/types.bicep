...
type privateDnsZone_new_t = {
  type: 'new' 
}

type privateDnsZone_existing_t = {
  type: 'existing'
  id: string
  vnetLink: bool?
}

type privateDnsZone_none_t = {
  type: 'none'
}

@discriminator('type')
@export()
type privateDnsZone_t = privateDnsZone_new_t | privateDnsZone_existing_t | privateDnsZone_none_t
