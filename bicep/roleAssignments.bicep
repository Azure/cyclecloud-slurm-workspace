...
param storageAccountName string  // Storage accounts names need minimum of three characters
param vmName string

var assignManagedIdentityRoles = principalName != vmName
...
resource storageAccount 'Microsoft.Storage/storageAccounts@2023-04-01' existing = if (assignManagedIdentityRoles) {
...
resource roleAssignments 'Microsoft.Authorization/roleAssignments@2022-04-01' = [ for role in roles: {
  ...
  scope: assignManagedIdentityRoles ? storageAccount : subscription()
  properties: {
