...
param cyclecloudBaseImage string = 'azurecyclecloud:azure-cyclecloud:cyclecloud8-gen2:8.9.320260827'
...
param projectVersion string = '2026.09.02'
// Must be updated with each Open OnDemand release
param oodProjectVersion string = '1.1.7'
