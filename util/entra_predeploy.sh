...
az deployment group create -g $ENTRA_MI_RESOURCE_GROUP --template-uri https://raw.githubusercontent.com/Azure/cyclecloud-slurm-workspace/refs/tags/2026.08.07/bicep/entra/ccwEntraApp.json --parameters ${DEPLOYMENT_PARAMS} --name ${ENTRA_DEPLOYMENT_NAME}
